<h1>Hello, I'm <a href="https://www.linkedin.com/in/braelyn-heath-mercado/"><code>Braelyn</code></a> and welcome to my student project portfolio!</h1>



<h2>ABOUT ME</h2>

### *I'm a college student attending Towson University, dual-majoring in Business Administration with a concentration in Project Management/Business Analysis and Information Systems under the Business Track.*

>**Career Plans:** My goal is to apply my academic knowledge to a career in project management and technology.
...
Pursuing: CompTIA Security+, EC-CoUncil Certified Ethical Hacker (CEH)

## <h2>IT Certifications</h2>

Pursuing: Microsoft Office Specialist (MOS) Excel
...
Pursuing: Google AI Essentials

## <h2>Project Management Certifications</h2>

 Pursing: PMI CAPM, Professional Scrum Master I (PSMI)
